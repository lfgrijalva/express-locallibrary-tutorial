...
exports.bookinstance_update_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        book: function(callback) {
            ...
            res.render('bookinstance_form', { title: 'Update BookInstance', bookinstance:results.bookinstance, book: results.book });
    });
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('bookinstance_form', { title: 'Update BookInstance',book:results.book, bookinstance: bookinstance, errors: errors.array() });
            });
            return;
        }
        else {
